# -*- coding: utf-8 -*-
#
# django-pushserver documentation build configuration file, created by
...
htmlhelp_basename = 'pushserverdoc'
...
latex_documents = [
  ('index', 'pushserver.tex', u'django-pushserver Documentation',
